 ...
 */
public class IRStatisticsInst implements IRStatistics, Serializable {
    ...
    IRStatisticsInst(double precision, double recall, double fallOut, double ndcg, double reach) {
